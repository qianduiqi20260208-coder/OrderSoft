...
CREATE TABLE IF NOT EXISTS encryption_key (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    shell_number VARCHAR(64) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS user_multi_role (
    ...
    role          ENUM('SuperUser','模型工程师','软件工程师','访客','null') NOT NULL DEFAULT 'null' COMMENT '系统角色',-- 根据role是否为null来区分角色的性质。是涉及到工单流程中的角色还是用户登录时显示的角色
